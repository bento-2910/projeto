...
import 'package:projeto/participa%C3%A7%C3%A3o_amigavel/part_11.dart';

import '../colors.dart';

class part_10 extends StatefulWidget {
  const part_10({super.key});

  @override
  State<part_10> createState() => _part_10State();
}

class _part_10State extends State<part_10> {
                ...
                SizedBox(
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          text: 'Dados referentes à seguradora do Veículo B',
