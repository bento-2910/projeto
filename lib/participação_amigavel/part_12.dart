...
class part_12 extends StatefulWidget {
  const part_12({super.key});

  @override
  State<part_12> createState() => _part_12State();
}

class _part_12State extends State<part_12> {
  @override
                ...
                SizedBox(
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          text: 'Dados referentes ao condutor do Veículo B',
